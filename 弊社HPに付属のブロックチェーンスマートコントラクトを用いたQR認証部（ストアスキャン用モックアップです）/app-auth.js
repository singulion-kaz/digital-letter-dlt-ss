/*
//------------------------------------------------
//name:Web3QRSCAN-demo_ShinCoinGate(TM)-v1
//
...
//contract
const gaContractAddress = "0xE9f6dC8440A4A6Ee4a54727f931174a21c7ab4c1";//生成部認証部
...
async function authQrVp(qrMes) {
  ...
  let tx;
  try {
      tx = await gaWithSigner.authVp(authNftId,authTotp);
  } catch (error) {
